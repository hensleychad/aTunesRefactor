...
#java -cp ./aTunes-test.jar:lib/commons-io-1.2.jar:lib/jcommon-1.0.0.jar:lib/jfreechart-1.0.1.jar:lib/jid3lib-0.5.4.jar:lib/entagged-audioformats-0.15.jar:lib/log4j-1.2.13.jar:lib/commons-logging-1.1.jar:lib/jdic.jar:lib/jdic_stub_linux.jar:lib/antBuildNumber.jar:lib/substance.jar:lib/oro.jar net.sourceforge.atunes.Main
java -cp $ATUNES_EXE:lib/commons-io-1.2.jar:lib/jcommon-1.0.0.jar:lib/jfreechart-1.0.1.jar:lib/jid3lib-0.5.4.jar:lib/entagged-audioformats-0.15.jar:lib/log4j-1.2.13.jar:lib/commons-logging-1.1.jar:lib/jdic.jar:lib/jdic_stub_linux.jar:lib/antBuildNumber.jar:lib/substance.jar:lib/oro.jar net.sourceforge.atunes.Main
